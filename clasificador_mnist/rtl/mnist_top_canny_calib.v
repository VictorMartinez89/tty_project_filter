// mnist_top_canny_calib.v — mnist_top_canny_fw.v con el clasificador de sesgos CALIBRADOS (94,20 % en vez de 92,46 %).
//   Mismos 400 pesos, mismo circuito: solo cambian los 10 sesgos (mnist_weights_canny_calib.vh). 24-sep-2026.
...
module mnist_top_canny_calib #(
    ...
    mnist_clf_canny_calib #(.CW(CW)) CLF (
