...
module soc_ctrl #(
    ...
    // thr_hi=90 y thr_lo=0. Para el Sobel da igual (solo usa thr_hi); para el Canny 1-salto
    // es fatal: con thr_lo=0 todo pixel es borde debil y la histeresis promueve casi todos.
    // Medido sobre las 10 000: 89.93 % con 0x5A00 contra 92.46 % con 0x5A20 (thr_lo=32).
