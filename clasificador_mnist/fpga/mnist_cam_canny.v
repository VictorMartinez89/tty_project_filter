// mnist_cam_canny.v — ESCRIBI UN DIGITO Y LA FPGA TE DICE CUAL ES, con front-end CANNY.
//   Identico a mnist_cam_display.v salvo por el clasificador: usa el Canny 1-salto (doble
//   umbral + histeresis) con sus propios pesos y umbrales de NADA. Existe para MEDIR si la
//   cadena entera entra en la iCE40UP5K, que es la pregunta que el area de sky130 no contesta:
//   en ASIC un line-buffer se paga en celdas, en FPGA es un bloque de BRAM que ya esta ahi.
//
