...
module top #(
    parameter [7:0] MASCARA = 8'hF0,  // que bits de cam_d se conservan
    parameter       FUENTE  = 0       // 0 = la camara · 1 = PATRON generado adentro
) (
    input  wire       clk,
        ...
        if (~cam_href) begin
            ...
            if (parity == 1'b0) curY <= cam_d;
                ...
                if (rowkeep==3'd0 && colkeep==4'd0 && fbx<7'd60) begin
                    ...
                    //     explique eso.
                    wdat <= FUENTE ? waddr_wr[7:0] : (curY & MASCARA);
