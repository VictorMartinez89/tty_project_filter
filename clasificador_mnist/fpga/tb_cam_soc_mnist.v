...
module tb_cam_soc_mnist;
    parameter integer FT = 0;      // 0 = umbral del CPU · 1 = cableado
    parameter [7:0]  TF = 8'd60;
    ...
    wire [7:0] thr_usado; wire cpu_escribio;
    soc_mnist_top #(.H(28),.W(28),.CW(9),.FUENTE_THR(FT),.THR_FIJO(TF)) CLF (
    ...
    initial begin
        ...
        $display("    umbral usado=%0d (%s)  ·  bordes=%0d",
                 thr_usado, FT==0 ? "lo puso el CPU" : "cableado", CLF.FEAT.n_bordes);
        $finish;
    end
endmodule
