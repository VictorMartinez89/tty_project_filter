#!/usr/bin/env python3
# render_5x6.py — dibuja la grilla del experimento: 5 imagenes x 6 disenos, a 36x26,
...
for r, nom in enumerate(IMGS):
    ...
    if r == 0:
        ejes[r, 0].set_title("entrada\n(36x26 gris)", fontsize=9.5, fontweight="bold")
...
fig.suptitle(f"Experimento 5x6 a 36x26 — 30 simulaciones RTL (iverilog): 5 imagenes x 6 disenos{UMB}\n"
