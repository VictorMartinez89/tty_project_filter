// vision_canny_mnist.v — EL CHIP QUE VE UN DIGITO Y DICE CUAL ES, con front-end CANNY.
//   camara OV7670 -> ventana central 448x448 -> 28x28 -> CANNY 1-salto + CLASIFICADOR -> TFT.
//
//   Portado del diseno FISICO verificado en FPGA (mnist_cam_canny.v, hermano del probado en silicio).
