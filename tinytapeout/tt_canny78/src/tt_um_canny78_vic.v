// tt_um_canny78_vic.v — Canny-78 en Tiny Tapeout: el reconocedor del 97,22 % (fmem 256x13).
//
...
//   El mismo RTL (mnist_top78) que se verifico contra el golden sobre las 10 000 del test.
